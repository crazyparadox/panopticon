    ...
    case "ollama":
      steps = [
        ...
        SetupStep(
          ...
          contentType: .information(
            "All set!", "Local AI is configured and ready to use with Panopticon.")),
      ]
    case "chatgpt_claude":
      ...
      steps = [
        SetupStep(
          ...
          contentType: .information(
            ...
            "If you have a paid ChatGPT/Claude account, you can have Panopticon tap into your existing usage limits. Everything flows through your current account - no extra charges - and you can opt out of training for privacy. You only need one CLI installed and signed in on this Mac; we'll verify it automatically next."
          )
        ),
        SetupStep(
          id: "detect",
    ...
    default:  // gemini
      steps = [
        ...
        SetupStep(
          id: "complete", title: "Complete",
          contentType: .information(
            "All set!", "Gemini is now configured and ready to use with Panopticon.")),
      ]
    }
  }
