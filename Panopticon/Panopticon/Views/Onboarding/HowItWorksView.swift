...
struct HowItWorksView: View {
  ...
  private let fullText = "How Panopticon Works"
  ...
  private let cards: [(icon: String, title: String, body: String)] = [
    (
      "OnboardingHow",
      "Install and Forget",
      "Panopticon takes periodic screen captures to understand what you're working on, all stored privately on your device. You can toggle this whenever you like."
    ),
    (
      "OnboardingSecurity",
      "Privacy by Default",
      "Panopticon can run entirely on local AI models, which means your data never leaves your computer. You can also find the source code below - please consider giving it a star on Github!"
    ),
    (
      "OnboardingUnderstanding",
      "Understand your Day",
      "Knows the difference between YouTube tutorials and YouTube rabbit holes. Panopticon actually gets what you're working on."
    ),
  ]
  ...
  var body: some View {
    ScrollView(.vertical, showsIndicators: false) {
      ...
      HStack {
        ...
        PanopticonSurfaceButton(
          action: {
            if let url = URL(string: "https://github.com/jerryzliu/Panopticon") {
