...
struct FeedbackModalContent {
  ...
  static let timeline = FeedbackModalContent(
    ...
    placeholder:
      "I don't have access to your timeline (privacy first!), so your feedback here helps improve the quality of Panopticon for everyone.",
    ...
    thanksBody:
      "If you find that your activities are summarized inaccurately, try editing the descriptions of your categories to improve Panopticon's accuracy.",
