  ...
  static func migrateIfNeeded() {
    ...
    let legacyBase = fileManager.homeDirectoryForCurrentUser
      .appendingPathComponent(
        "Library/Containers/\(bundleID)/Data/Library/Application Support/Panopticon", isDirectory: true
      )
    ...
    let destinationBase = newSupport.appendingPathComponent("Panopticon", isDirectory: true)
