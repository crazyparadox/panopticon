...
extension StorageManager {
  ...
  /// Creates a dummy "Installed Panopticon!" card when onboarding completes.
  ...
  func createOnboardingCard() {
    ...
    let meta = TimelineMetadata(
      distractions: nil,
      appSites: AppSites(primary: "panopticon.so", secondary: nil),
  ...
  func buildOnboardingSummary() -> String {
    ...
    case "gemini":
      return
        "You successfully installed Panopticon and configured it with Gemini AI. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
    ...
    case "chatgpt_claude":
      ...
      if cliTool == "codex" {
        return
          "You successfully installed Panopticon with ChatGPT. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
      } else {
        return
          "You successfully installed Panopticon with Claude. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
      }
    ...
    case "ollama":
      ...
      if localEngine == "lmstudio" {
        return
          "You successfully installed Panopticon with LM Studio — your data stays 100% on your device. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
      } else {
        return
          "You successfully installed Panopticon with Ollama — your data stays 100% on your device. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
      }

    default:
      return
        "You successfully installed Panopticon. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
    }
  }
