...
final class KeychainManager {
  ...
  private let servicePrefix = "com.teleportlabs.panopticon.apikeys"
  private let queue = DispatchQueue(label: "com.teleportlabs.panopticon.keychain", qos: .userInitiated)
  ...
  ///   - provider: The provider identifier (e.g., "gemini", "panopticon")
